...
#
#   - This script requires a Java 8 or later JRE/JDK to be available on PATH or via JAVA_HOME.
#   - It will download/extract the Gradle distribution specified by the wrapper properties.
#
##############################################################################
